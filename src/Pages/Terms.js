      ...
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <div className="space-y-6">
          <section>
            ...
            <p>Welcome to CoffeeCafe. By accessing or using our website, you agree to be bound by these Terms and conditions. If you do not agree with these Terms, please do not use our website.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li><strong>Ownership:</strong> All content on this website, including text, graphics, logos, images, and software, is the property of CoffeeCafe and is protected by copyright, trademark, and other intellectual property laws.</li>
