    ...
    <FooterContainer>
      <FooterContent>
        ...
        <SocialIcons>
          ...
          <SocialIcon
            href="https://github.com/GitWizzz/CoffeeWeb"
            target="_blank"
        ...
        <InfoColumn>
            <h3>About Us</h3>
            <p>
              Founded in 2010, CoffeeCafe is dedicated to serving the finest coffee
          ...
          <InfoColumn>
            <h3>Contact Us</h3>
            <p><a href="mailto:contact@gitwizzz.com">✉️ contact@gitwizzz.com</a></p>
        ...
        {/* Footer Text */}
        <p>&copy; {new Date().getFullYear()} CoffeeCafe. All rights reserved.</p>
        <p>Made with ♥ by GitWizzz</p>
      </FooterContent>
    </FooterContainer>
  );
}
